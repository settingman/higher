...
public class ChatController {
	...
	public void enterUser(@Payload ChatDTO chat, SimpMessageHeaderAccessor headerAccessor) {
		...
		String userUUID = msgChatService.addUser(ChatRoomMap.getInstance().getChatRooms(), chat.getRoomId(),
				chat.getSender());
	...
	public void webSocketDisconnectListener(SessionDisconnectEvent event) {
		...
		String username = msgChatService.findUserNameByRoomIdAndUserUUID(ChatRoomMap.getInstance().getChatRooms(),
				roomId, userUUID);
		...
		if (username != null) {
			...
			ChatDTO chat = ChatDTO.builder().type(ChatDTO.MessageType.LEAVE).sender(username)
					.message(username + " 님 퇴장!!").build();
