 ...
 * ----------      --------    ---------------------------
 * 2023. 3. 15.     박성환      	최초 생성
 * 2023. 3. 29 		박성환			회원 예약 생성 테이블 업데이트 추가.
 *     </pre>
 */
@Controller
...
public class ChatRoomController {
	...
	public String createRoom(@RequestParam("roomName") String name, @RequestParam("roomPwd") String roomPwd,
			...
			@RequestParam("chatType") String chatType, @RequestParam("customerID") String customerID,
			@RequestParam("reservationID") String reservationID, RedirectAttributes rttr) {
