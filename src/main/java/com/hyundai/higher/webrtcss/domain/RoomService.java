package com.hyundai.higher.webrtcss.domain;
...
import com.hyundai.higher.webrtcss.util.Parser;
...
public class RoomService {
	...
	public Map<String, WebSocketSession> getClients(final Room room) {
		return Optional.ofNullable(room).map(r -> Collections.unmodifiableMap(r.getClients()))
